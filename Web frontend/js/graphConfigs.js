const configs = {
    ...
    'avgplaces': {
        ...
        'text': 'How many new places the users visited on average. A new place is registreded if it sufficiently far away from already visited places and the time spent at the new place is sufficiently long. For example driving from Malmö to Göteborg will generate 1 new place in Göteborg and not a bunch of new places along E6.'
    }
}